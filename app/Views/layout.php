...
<head>
  ...
  <title>CV-RAINA RAHMAWATI FITRI</title>
  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
      <ul>
        ...
        <li><a href="#skills" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Keahlian</span></a></li>
        <li><a href="#portfolio" class="nav-link scrollto"><i class="bx bx-book-content"></i> <span>Dokumentasi</span></a></li>
...
<footer id="footer">
    <div class="container">
      ...
      <p>Seorang Mahasiswi dari Universitas Muhammadiyah Sukabumi</p>
